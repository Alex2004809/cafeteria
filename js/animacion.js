    ...
    $('.menu a').each(function (index, elemento) {
       ...
       //Scroll de los elementos del menú
         ...
         $('#btn-menu').on('click', function(e){
             e.preventDefault()//Evito el comportamiento por defecto del enlace
             $('html, body').animate({
                 scrollTop: menu -100 //Desplaza la posición vertical de la página a la sección scercaDe
             }, 500)//El tiempo que e demora en el desplzamiento
         ...
         $('#btn-galeria').on('click', function(e){
             e.preventDefault()//Evito el comportamiento por defecto del enlace
             $('html, body').animate({
                 scrollTop: galeria -100 //Desplaza la posición vertical de la página a la sección scercaDe
             }, 500)//El tiempo que e demora en el desplzamiento
